...
def generate():
    ...
    q += r""". We aim to minimise this function in the given region defined by the constraints. Write down the (Wolfe) dual problem, if applicable. Otherwise, show that the given problem is not convex."""
